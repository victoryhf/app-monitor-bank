...
.systitle{
	...
	color:#3F3F3F;
	background-color:inherit;
	background:url(https://sars.99bill.net/sor/monitor-bank/images/systitle.png) left top no-repeat;
}
...
#bodyTopMain{
	...
	min-width:1260px;
	height:3px;
	background:url(https://sars.99bill.net/sor/monitor-bank/images/body_top_bg.gif) 0 0 repeat-x #39A09B;
	color:#C5F6F2;
	padding:auto;
	z-index: 100;
}
...
<div id="topMain">
   <div id ="topContainer">
       <div id ="top">
            <img src="https://sars.99bill.net/sor/monitor-bank/images/logo.gif" alt="foot step" width="79" height="44" class="logo">
