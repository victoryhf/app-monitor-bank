...
public class Config implements Serializable {
    /**
     * author：皇甫立胜 data：2015-12-4 作用：配置表实体bean
     */
    ...
    public Config(String bankid, String bankname, String sla_threshold,
            String available_ratio_threshold, String max_beyond_time,
            Integer rstatus, String mail_to) {
        super();
        this.bankid = bankid;
    ...
    public Config(int id, String bankid, String bankname, String sla_threshold,
            String available_ratio_threshold, String max_beyond_time,
            Integer rstatus, String mail_to) {
        super();
        this.id = id;
    ...
    public String toString() {
        return "Config [id=" + id + ", bankid=" + bankid + ", bankname="
                + bankname + ", sla_threshold=" + sla_threshold
                + ", available_ratio_threshold=" + available_ratio_threshold
                + ", max_beyond_time=" + max_beyond_time + ", rstatus="
                + rstatus + ", mail_to=" + mail_to + "]";
    }
