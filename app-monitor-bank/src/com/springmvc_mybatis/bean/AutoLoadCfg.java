...
public class AutoLoadCfg {
    ...
    /*
     * public Object getKey() { Set<Map.Entry<String,Object>>
     * sets=map.entrySet(); for(Map.Entry<String,Object> entry:sets){
     * System.out.println("key:"+entry.getKey()); } return sets; }
