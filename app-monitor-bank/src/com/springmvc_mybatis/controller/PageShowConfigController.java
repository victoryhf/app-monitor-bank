...
public class PageShowConfigController {
    ...
    public String pageShowConfigList(Model model) {
        try {
            List<PageShowConfig> pageShowConfigList = pageShowConfigService
                    .pageShowConfigList();
    ...
    public void addPageShowConfig(HttpServletResponse response,
    ...
    public void findPageShowConfigById(HttpServletResponse response,
            PageShowConfig pageShowConfig) {
        try {
            pageShowConfig = pageShowConfigService
                    .findPageShowConfigById(pageShowConfig);
    ...
    public void modifyPageShowConfig(HttpServletResponse response,
            PageShowConfig pageShowConfig) {
        try {
    ...
    public void deletePageShowConfig(HttpServletResponse response,
            PageShowConfig pageShowConfig) {
        try {
